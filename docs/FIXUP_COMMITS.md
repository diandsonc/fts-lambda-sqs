...
If you want to send your branch to `FTSPreca:develop`, you should make [squash](#squash-fixup-commits) fixup commits with the corresponding regular commits.
...
## <a name="squash-fixup-commits"></a> Rebasing to squash fixup commits
